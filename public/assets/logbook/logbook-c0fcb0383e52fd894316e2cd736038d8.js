...
(function() {
  window.dream = {
    ...
    initialize: function(data) {
      ...
      this.presenter = new dream.AppPresenter(this);
...
(function() { this.JST || (this.JST = {}); this.JST["logbook/templates/app/sidebar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class=\'tabs\'>\n  '); for (var i=0; i<tabs.length; i++) { __p.push('\n    <li class=\'tab\' data-presenter=\'', tabs[i].presenter ,'\'>\n      <span class=\'mega-octicon octicon-', tabs[i].icon ,'\'></span>\n      ', tabs[i].label ,'\n    </li>\n  '); } __p.push('\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["logbook/templates/app/tab"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<span class=\'mega-octicon octicon-', tab.icon ,'\'></span>\n', tab.label ,'\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["logbook/templates/people/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="people-list" class="list list-with-toolbar">\n  <div class=\'list-title\'>\n    <h1>People</h1>\n    <div class="r-menu">\n      <a href="#new">New</a>\n    </div>\n  </div>\n  <div class=\'list-body scrollable\'>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["logbook/templates/people/person"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'list-item-graphic\'>\n  ', first_name.slice(0,1) ,'',last_name.slice(0,1) ,'\n</div>\n<div class=\'list-item-label\'>\n  ', first_name ,'\n  ', last_name ,'\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["logbook/templates/people/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'panel list-detail\'>\n  <div class=\'panel-title\'>\n    <h1>Showing Person</h1>\n  </div>\n\n  <div class="panel-body scrollable pad">\n  <h1>', first_name ,' ', last_name ,'</h1>\n  <ul class="stats">\n  <li class="stat">\n  <h1>0</h1>\n  <span>primary projects</span>\n  </li>\n  <li class="stat">\n  <h1>0</h1>\n  <span>secondary projects</span>\n  </li>\n  <li class="stat">\n  <h1>0</h1>\n  <span>workshops attended</span>\n  </li>\n  <li class="stat">\n  <h1>0.0</h1>\n  <span>hours in one-on-ones</span>\n  </li>\n  </ul>\n  <hr>\n  <h5>One-on-Ones</h5>\n  <form accept-charset="UTF-8" action="/logbook/one_on_ones" class="quick_add" id="new_one_on_one" method="post"><div style="display:none"><input name="utf8" type="hidden" value="✓"><input name="authenticity_token" type="hidden" value="7CQHmC2WNx/rqrkU9XiweAtlppKfdyQgpldSHpaVcs4="></div><div class="quick_primary_inputs">\n  <input id="one_on_one_note" name="one_on_one[note]" placeholder="New..." type="text">\n  <input id="one_on_one_person_id" name="one_on_one[person_id]" type="hidden" value="23">\n  <input id="one_on_one_school_id" name="one_on_one[school_id]" type="hidden" value="1">\n  <input id="one_on_one_date" name="one_on_one[date]" type="hidden" value="2014-08-02">\n  </div>\n  <div class="quick_secondary_inputs">\n  <label for="one_on_one_duration">It lasted:</label>\n  <select id="one_on_one_duration" name="one_on_one[duration]"><option value="0.25">15 minutes</option>\n  <option value="0.5">30 minutes</option>\n  <option value="1">1 hour</option>\n  <option value="1.5">1.5 hours</option>\n  <option value="2.0">2 hours</option>\n  <option value="3.0">3 hours</option></select>\n  <input name="commit" type="submit" value="Log It">\n  </div>\n  <ul class="one_on_ones">\n  </ul>\n  </form>\n\n  <hr>\n  <h5>Activity</h5>\n  </div>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["logbook/templates/projects/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="people-list" class="list list-with-toolbar">\n  <div class=\'list-toolbar\'>\n    <div class=\'button-group\'>\n      <button class=\'core\'>Core</button>\n      <button class=\'students\'>Students</button>\n      <button class=\'faculty\'>Faculty</button>\n    </div>\n  </div>\n  <div class=\'list-items\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  dream.Models.Person = (function(_super) {
    ...
    Person.prototype.initialize = function() {
      return this.on('change:selected', this.broadcastIfShowing);
    };

    Person.prototype.toJSON = function() {
      return _.omit(this.attributes, 'selected');
    };

    Person.prototype.broadcastIfShowing = function() {
      if (this.has('selected')) {
        return Backbone.trigger('person:selected', this);
      }
    };
  ...
  dream.Collections.People = (function(_super) {
    ...
    People.prototype.initialize = function() {
      return this.on('reset add remove', this.broadcast);
    };

    People.prototype.model = dream.Models.Person;

    People.prototype.url = '/people';

    People.prototype.select = function(person) {
      return this.each(function(p) {
        if (p === person) {
          return p.set('selected', true);
        } else {
          return p.unset('selected');
        }
      });
    };

    People.prototype.broadcast = function() {
      return Backbone.trigger('peopleCollection:changed', this);
    };
...
(function() {
  ...
  (_base = dream.Views).App || (_base.App = {});

  dream.Views.App.TabView = (function(_super) {
    ...
    TabView.prototype.initialize = function(attrs) {
      this.presenter = attrs.presenter;
      this.attrs = attrs;
      this.listenTo(Backbone, 'presenter:presenting', this.setClass);
      return this.render();
    };

    TabView.prototype.className = 'tab';

    TabView.prototype.tagName = 'li';

    TabView.prototype.events = {
      'click': 'present'
    };

    TabView.prototype.template = JST['logbook/templates/app/tab'];

    TabView.prototype.render = function() {
      this.$el.html(this.template({
        tab: this.attrs
      }));
      return $(this.attrs.parentEl).append(this.el);
    };

    TabView.prototype.present = function() {
      return this.presenter.present('index', {
        url: this.attrs.url
      });
    };

    TabView.prototype.setClass = function(presenter) {
...
(function() {
  ...
  (_base = dream.Views).People || (_base.People = {});

  dream.Views.People.IndexView = (function(_super) {
    ...
    IndexView.prototype.initialize = function(args) {
      return this.listenTo(Backbone, 'peopleCollection:changed', this.display);
    };

    IndexView.prototype.display = function(collection) {
      this.collection = collection;
      return this.render();
    };

    IndexView.prototype.template = JST['logbook/templates/people/index'];

    IndexView.prototype.render = function() {
      var frag, _ref;
      this.$el.html(this.template());
      this.$list = this.$el.find('.list-body');
  ...
  dream.Views.People.PersonView = (function(_super) {
    ...
    PersonView.prototype.initialize = function(args) {
      this.model = args.model;
      return this.listenTo(this.model, 'change:selected', this.render);
    };

    PersonView.prototype.template = JST['logbook/templates/people/person'];

    PersonView.prototype.className = 'list-item';

    PersonView.prototype.events = {
      'click': 'select'
    };

    PersonView.prototype.select = function() {
      return this.model.collection.select(this.model);
    };
...
(function() {
  ...
  dream.Views.People.ShowView = (function(_super) {
    ...
    ShowView.prototype.initialize = function(args) {
      return this.listenTo(Backbone, 'person:selected', this.display);
    };

    ShowView.prototype.className = 'panel list-detail';

    ShowView.prototype.template = JST['logbook/templates/people/show'];

    ShowView.prototype.display = function(model) {
      this.model = model;
      this.render();
      return Backbone.trigger('router:update', "logbook/people/" + (this.model.get('id')));
    };
...
(function() {
  ...
  (_base = dream.Views).Projects || (_base.Projects = {});

  dream.Views.Projects.FormView = (function(_super) {
...
(function() {
  ...
  dream.Views.Projects.IndexView = (function(_super) {
    __extends(IndexView, _super);
...
(function() {
  ...
  (_base = dream.Views).Tasks || (_base.Tasks = {});

  dream.Views.Tasks.FormView = (function(_super) {
    __extends(FormView, _super);
...
(function() {
  ...
  dream.Views.Tasks.IndexView = (function(_super) {
    __extends(IndexView, _super);
...
(function() {
  ...
  (_base = dream.Views).Workshops || (_base.Workshops = {});

  dream.Views.Workshops.FormView = (function(_super) {
    __extends(FormView, _super);
    ...
    FormView.prototype.initialize = function() {
      return $('#workshop_attendee_ids').selectize();
    };
...
(function() {
  ...
  dream.Views.Workshops.IndexView = (function(_super) {
    __extends(IndexView, _super);
...
(function() {
  ...
  dream.Routers.AppRouter = (function(_super) {
    ...
    AppRouter.prototype.initialize = function() {
      return this.listenTo(Backbone, 'router:update', this.update);
    };

    AppRouter.prototype.update = function(route) {
    ...
    AppRouter.prototype.stats_index = function() {
      return Backbone.trigger('stats:present', 'index');
    };

    AppRouter.prototype.people_index = function() {
      return Backbone.trigger('people:routeTo', 'index');
    };

    AppRouter.prototype.people_new = function() {
      return Backbone.trigger('people:present', 'new');
    };

    AppRouter.prototype.people_edit = function(id) {
      return Backbone.trigger('people:present', 'edit');
    };

    AppRouter.prototype.people_show = function(id) {
      return Backbone.trigger('people:routeTo', 'show', id);
    };

    AppRouter.prototype.projects_index = function() {
      return Backbone.trigger('projects:present', 'index');
    };

    AppRouter.prototype.projects_new = function() {
      return Backbone.trigger('projects:present', 'new');
    };

    AppRouter.prototype.projects_edit = function(id) {
      return Backbone.trigger('projects:present', 'edit');
    };

    AppRouter.prototype.projects_show = function(id) {
      return Backbone.trigger('projects:present', 'edit');
    };

    AppRouter.prototype.task_assignments_index = function() {
      return Backbone.trigger('task_assignments:present', 'index');
    };

    AppRouter.prototype.task_assignments_new = function() {
      return Backbone.trigger('task_assignments:present', 'new');
    };

    AppRouter.prototype.task_assignments_edit = function(id) {
      return Backbone.trigger('task_assignments:present', 'edit');
    };

    AppRouter.prototype.task_assignments_show = function(id) {
      return Backbone.trigger('task_assignments:present', 'edit');
    };

    AppRouter.prototype.workshops_index = function() {
      return Backbone.trigger('workshops:present', 'index');
    };

    AppRouter.prototype.workshops_new = function() {
      return Backbone.trigger('workshops:present', 'new');
    };

    AppRouter.prototype.workshops_edit = function(id) {
      return Backbone.trigger('workshops:present', 'edit');
    };

    AppRouter.prototype.workshops_show = function(id) {
      return Backbone.trigger('workshops:present', 'edit');
    };
...
(function() {
  ...
  dream.Routers.PeopleRouter = (function(_super) {
    __extends(PeopleRouter, _super);

    function PeopleRouter() {
      return PeopleRouter.__super__.constructor.apply(this, arguments);
    }

    PeopleRouter.prototype.initialize = function(args) {
      this.presenter = args.presenter;
      return this.listenTo(Backbone, 'router:update', this.updateRoute);
    };

    PeopleRouter.prototype.updateRoute = function(route) {
      return this.navigate(route);
    };

    PeopleRouter.prototype.routes = {
    ...
    PeopleRouter.prototype.index = function() {
      return Backbone.trigger('people:present');
    };

    PeopleRouter.prototype["new"] = function() {
      return Backbone.trigger('people:present');
    };

    PeopleRouter.prototype.edit = function(id) {
      return Backbone.trigger('people:present');
    };

    PeopleRouter.prototype.show = function(id) {
      Backbone.trigger('people:present');
      return this.presenter.collection.fetch({
        complete: (function(_this) {
          return function() {
            return _this.presenter.collection.select(_this.presenter.collection.get(id));
          };
        })(this)
      });
    };
...
(function() {
  ...
  dream.Routers.ProjectsRouter = (function(_super) {
    ...
    ProjectsRouter.prototype.index = function() {
      return Backbone.trigger('projects:present', 'index');
    };

    ProjectsRouter.prototype["new"] = function() {
      return Backbone.trigger('projects:present', 'new');
    };
    ...
    ProjectsRouter.prototype.show = function(id) {
      return Backbone.trigger('projects:present', 'edit');
    };
...
(function() {
  ...
  dream.Routers.TasksRouter = (function(_super) {
    __extends(TasksRouter, _super);

    function TasksRouter() {
      return TasksRouter.__super__.constructor.apply(this, arguments);
    }

    TasksRouter.prototype.routes = {
      'logbook/tasks': 'index',
    ...
    TasksRouter.prototype.index = function() {
      return Backbone.trigger('tasks:present', 'index');
    };

    TasksRouter.prototype["new"] = function() {
      return Backbone.trigger('tasks:present', 'new');
    };

    TasksRouter.prototype.edit = function(id) {
      return Backbone.trigger('tasks:present', 'edit');
    };

    TasksRouter.prototype.show = function(id) {
      return Backbone.trigger('tasks:present', 'edit');
    };
...
(function() {
  ...
  dream.Routers.WorkshopsRouter = (function(_super) {
    __extends(WorkshopsRouter, _super);

    function WorkshopsRouter() {
      return WorkshopsRouter.__super__.constructor.apply(this, arguments);
    }

    WorkshopsRouter.prototype.routes = {
    ...
    WorkshopsRouter.prototype.index = function() {
      return Backbone.trigger('workshops:present', 'index');
    };

    WorkshopsRouter.prototype["new"] = function() {
      return Backbone.trigger('workshops:present', 'new');
    };

    WorkshopsRouter.prototype.edit = function(id) {
      return Backbone.trigger('workshops:present', 'edit');
    };

    WorkshopsRouter.prototype.show = function(id) {
      return Backbone.trigger('workshops:present', 'edit');
    };

    return WorkshopsRouter;
...
(function() {
  ...
  dream.AppPresenter = (function(_super) {
    __extends(AppPresenter, _super);

    function AppPresenter() {
      return AppPresenter.__super__.constructor.apply(this, arguments);
    }

    AppPresenter.prototype.initialize = function(app) {
      this.app = app;
      this.render();
      this.tweakUI();
      this.prepAjax();
    ...
    AppPresenter.prototype.el = '#canvas';

    AppPresenter.prototype.render = function() {
      return this.$el.html('<div id="logbook_home" class="tab_target"></div> <div id="logbook_tasks" class="tab_target"></div> <div id="logbook_people" class="tab_target"></div> <div id="logbook_projects" class="tab_target"></div> <div id="logbook_workshops" class="tab_target"></div>');
    };

    AppPresenter.prototype.prepAjax = function() {
      return $.ajaxPrefilter(function(options, originalOptions, jqXHR) {
        options.url = "/api/v1" + options.url + ".json";
        return jqXHR.withCredentials = true;
      });
    };

    AppPresenter.prototype.tweakUI = function() {
    ...
    AppPresenter.prototype.initViews = function() {};

    AppPresenter.prototype.initPresenters = function() {
    ...
    AppPresenter.prototype.initRouter = function() {
      return this.routers = {
        people: new dream.Routers.PeopleRouter({
          presenter: this.presenters.people
        })
      };
    };
...
(function() {
  ...
  dream.PeoplePresenter = (function(_super) {
    __extends(PeoplePresenter, _super);

    function PeoplePresenter() {
      return PeoplePresenter.__super__.constructor.apply(this, arguments);
    }

    PeoplePresenter.prototype.el = '#logbook_people';

    PeoplePresenter.prototype.initialize = function(args) {
      this.render();
      this.tab = new dream.Views.App.TabView({
        presenter: this,
    ...
    PeoplePresenter.prototype.listen = function() {
      this.listenTo(Backbone, 'people:present', this.present);
      return this.listenTo(Backbone, 'people:routeTo', this.routeTo);
    };

    PeoplePresenter.prototype.initCollection = function() {
      return this.collection = new dream.Collections.People;
    };

    PeoplePresenter.prototype.render = function() {
      return this.$el.html("<div id='logbook_people_index'></div> <div id='logbook_people_detail'></div>");
    };

    PeoplePresenter.prototype.present = function(view, args) {
      this.collection.fetch();
      this.$el.show().siblings().hide();
      Backbone.trigger('presenter:presenting', this);
      if ((args != null ? args.url : void 0) != null) {
        return Backbone.trigger('router:update', args.url);
      }
    };

    PeoplePresenter.prototype.initViews = function() {
      this.index = new dream.Views.People.IndexView({
        el: '#logbook_people_index',
        collection: this.collection
      });
      return this.show = new dream.Views.People.ShowView({
        el: '#logbook_people_detail'
      });
    };

    PeoplePresenter.prototype.routeTo = function(action, id) {
      var _ref;
      this.present();
      return (_ref = this.routerActions[action]) != null ? _ref.call(this) : void 0;
    };

    PeoplePresenter.prototype.routerActions = {
      index: function() {},
      show: function() {}
    };
...
(function() {
  ...
  dream.ProjectsPresenter = (function(_super) {
    __extends(ProjectsPresenter, _super);

    function ProjectsPresenter() {
      return ProjectsPresenter.__super__.constructor.apply(this, arguments);
    }

    ProjectsPresenter.prototype.initialize = function() {
      this.initRouter();
      this.initViews();
      this.initCollection();
      return this.listenTo(Backbone, 'projects:present', this.present);
    };

    ProjectsPresenter.prototype.initRouter = function() {
      return this.router = new dream.Routers.ProjectsRouter;
    };

    ProjectsPresenter.prototype.initViews = function() {
      return this.views = {
    ...
    ProjectsPresenter.prototype.initCollection = function() {};

    ProjectsPresenter.prototype.present = function(view) {
      if (this.views[view] != null) {
        return new this.views[view];
      }
    };
...
(function() {
  ...
  dream.StatsPresenter = (function(_super) {
    __extends(StatsPresenter, _super);

    function StatsPresenter() {
      return StatsPresenter.__super__.constructor.apply(this, arguments);
    }

    StatsPresenter.prototype.initialize = function(args) {
      this.render();
      this.initViews();
      this.initCollection();
      return this.listenTo(Backbone, 'stats:present', this.present);
    };

    StatsPresenter.prototype.el = '#logbook_people';

    StatsPresenter.prototype.initViews = function() {
      return this.views = {
    ...
    StatsPresenter.prototype.initCollection = function() {};

    StatsPresenter.prototype.present = function(view, args) {
      var v;
      Backbone.trigger('presenter:presenting', 'stats');
      this.$el.show().siblings().hide();
      if (this.views[view] != null) {
        v = new this.views[view];
        return v.render();
      }
    };
...
(function() {
  ...
  dream.TaskAssignmentsPresenter = (function(_super) {
    __extends(TaskAssignmentsPresenter, _super);

    function TaskAssignmentsPresenter() {
      return TaskAssignmentsPresenter.__super__.constructor.apply(this, arguments);
    }

    TaskAssignmentsPresenter.prototype.initialize = function() {
      this.initViews();
      this.initCollection();
      return this.listenTo(Backbone, 'tasks:present', this.present);
    };

    TaskAssignmentsPresenter.prototype.initViews = function() {
      return this.views = {
    ...
    TaskAssignmentsPresenter.prototype.initCollection = function() {};

    TaskAssignmentsPresenter.prototype.present = function(view) {
      if (this.views[view] != null) {
        return new this.views[view];
      }
    };

    return TaskAssignmentsPresenter;
...
(function() {
  ...
  dream.WorkshopsPresenter = (function(_super) {
    __extends(WorkshopsPresenter, _super);

    function WorkshopsPresenter() {
      return WorkshopsPresenter.__super__.constructor.apply(this, arguments);
    }

    WorkshopsPresenter.prototype.initialize = function() {
      this.initRouter();
      this.initViews();
      this.initCollection();
      return this.listenTo(Backbone, 'workshops:present', this.present);
    };

    WorkshopsPresenter.prototype.initRouter = function() {
      return this.router = new dream.Routers.WorkshopsRouter;
    };

    WorkshopsPresenter.prototype.initViews = function() {
      return this.views = {
    ...
    WorkshopsPresenter.prototype.initCollection = function() {};

    WorkshopsPresenter.prototype.present = function(view) {
      if (this.views[view] != null) {
        return new this.views[view];
      }
    };

    return WorkshopsPresenter;
