...
(function() { this.JST || (this.JST = {}); this.JST["cic/templates/projects/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="people-list" class="list list-with-toolbar">\n  <div class=\'list-toolbar\'>\n    <div class=\'button-group\'>\n      <button class=\'core\'>Core</button>\n      <button class=\'students\'>Students</button>\n      <button class=\'faculty\'>Faculty</button>\n    </div>\n  </div>\n  <div class=\'list-items\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  dream.Models.Project = (function(_super) {
  ...
  dream.Collections.Projects = (function(_super) {
    ...
    Projects.prototype.model = dream.Models.Project;

    Projects.prototype.url = '/projects';

    Projects.prototype.initialize = function() {};

    Projects.prototype.onChange = function() {
      this.sort();
      return this.sendModels(null, null, this.lastFilter);
    };
...
(function() {
  ...
  dream.TasksPresenter = (function(_super) {
    __extends(TasksPresenter, _super);

    function TasksPresenter() {
      return TasksPresenter.__super__.constructor.apply(this, arguments);
    }

    TasksPresenter.prototype.initialize = function() {
      this.initRouter();
      this.initViews();
      this.initCollection();
    ...
    TasksPresenter.prototype.initRouter = function() {
      return this.router = new dream.Routers.TasksRouter;
    };

    TasksPresenter.prototype.initViews = function() {
      return this.views = {
    ...
    TasksPresenter.prototype.initCollection = function() {};

    TasksPresenter.prototype.present = function(view) {
      if (this.views[view] != null) {
        return new this.views[view];
      }
    };
