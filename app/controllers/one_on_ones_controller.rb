class OneOnOnesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @one_on_one.save
        format.html { redirect_to @one_on_one.person, notice: 'OneOnOne was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @one_on_one.update(one_on_one_params)
        format.html { redirect_to @one_on_one, notice: 'OneOnOne was successfully updated.' }
  ...
  def destroy
    @one_on_one.destroy
    respond_to do |format|
      format.html { redirect_to one_on_ones_url, notice: 'OneOnOne was successfully destroyed.' }
